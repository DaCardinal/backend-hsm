...
class UnderContractRouter(BaseCRUDRouter):
    ...
    def __init__(self, prefix: str = "", tags: List[str] = []):
        ...
        self.dao : UnderContractDAO = UnderContractDAO(nesting_degree=BaseCRUDRouter.NO_NESTED_CHILD, excludes=[''])

        super().__init__(dao=self.dao, schemas=UnderContractSchema, prefix=prefix,tags = tags)
