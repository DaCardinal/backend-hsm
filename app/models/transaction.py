...
class Transaction(Base):
    ...
    client_offered = Column(UUID(as_uuid=True), ForeignKey('users.user_id')) # payer_name
    client_requested = Column(UUID(as_uuid=True), ForeignKey('users.user_id')) # payee_name
