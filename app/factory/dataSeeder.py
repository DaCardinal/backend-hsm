        ...
        for item_data in data:
            ...
            if not item:
                ...
                if data_factory.model.__name__ == 'User':
                    ...
                    await db_crud_dao.add_user_role(db_session=session, user_id=user.user_id, role_alias=role)

    async def _process_role_permissions(self, session: AsyncSession, data_factory: DataFactory):
        query_key, data = data_factory.create_data()
        ...
        for role_permission in data:
            ...
            for permission in role_permissions:
                await db_crud_dao.add_role_permission(db_session=session, role_alias=role_name, permission_alias=permission['alias'])